# -*- coding: utf-8 -*-
from StringUtil_bak import StringUtil_bak
...
PATH_XIAOBEN_CLEAN = MAIN_PATH + '/' + 'xiaoben_cleaned_bak.txt'
...
def getCleanSubjiects(listSujects):
    ...
    for dictSubject in listSujects:
        ...
        if oriContent:
            #去掉题干Tab
            contentDelTab = objUtilString.replaceTab(oriContent)
            dictSubject['txt_content_deltab'] = contentDelTab
            #全角转半角
            ...
            dictSubject['txt_content_deltab'] = ''
...
if __name__ == "__main__":
    ...
    for dictSubject in listCleanSubjects:
        ...
        fileOut.write(nullDef(dictSubject['txt_content_deltab']) + '\t')
